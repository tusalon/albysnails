...
const urlsToCache = [
  ...
  '/albysnails/admin.html',
  '/albysnails/admin-login.html',
  '/albysnails/calendar.html',
  '/albysnails/setup-wizard.html',
  '/albysnails/editar-negocio.html',
  '/albysnails/manifest.json',
  '/albysnails/icons/icon-72x72.png',
  '/albysnails/icons/icon-96x96.png',
  '/albysnails/icons/icon-128x128.png',
  '/albysnails/icons/icon-144x144.png',
  ...
  '/albysnails/utils/push-config.js',
  '/albysnails/utils/push-notifications.js'
];
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/albysnails/icons/icon-192x192.png');
          }
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/albysnails/icons/icon-192x192.png',
    badge: '/albysnails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/albysnails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/albysnails/admin.html';
  event.waitUntil(
...
console.log('✅ Service Worker configurado para Albys Nails');
